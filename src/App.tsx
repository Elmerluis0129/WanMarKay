...
// Componente para el fondo animado que usa el tema
      ...
      <style>{`
        ...
        .animated-bg {
          ...
          background: ${mode === 'light' 
            ? 'linear-gradient(120deg, #fbeff7 0%, #f7e9f3 100%, #fff 100%)'
            : 'linear-gradient(120deg, #2D2535 0%, #23202B 100%, #1E1B24 100%)'};
